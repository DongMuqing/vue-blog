            ...
            <div class="login-wrapper">
                ...
                <div class="other-login-wrapper">
                    <div class="other-login-item">
                        <img src="../assets/loginimg/QQ.png" alt="">
                    </div>
                    <div class="other-login-item">
                        <img src="../assets/loginimg/WeChat.png" alt="">
                    </div>
                </div>
            </div>
        </div>
...
* {
  ...
  @media (min-width: 767px) {
    ...
    .box .content {
      width: 85vw;
      height: 90vh;
      background: url("../assets/loginimg/login_two.jpg") no-repeat;
  ...
  @media (max-width: 768px) {
    .box .content {
      width: 100vw;
      height: 100vh;
      background: url("../assets/loginimg/login_bg_phone.png") no-repeat;
